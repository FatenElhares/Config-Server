    ...
    node {
        ...
        try {
            ...
            stage('Push Image') {
                ...
                "docker save ${config.projectName} | bzip2 | pv | ssh ${ssh} 'bunzip2 | docker load' ".execute()
            ...
            stage('Deploy Image') {
                ...
                "ssh ${ssh}  docker run -d -p ${config.serverDomain}:${config.serverDomain} ${config.projectName}".execute()
